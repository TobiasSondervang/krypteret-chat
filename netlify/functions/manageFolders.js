        ...
        if (action === "create") {
            if (!storage.folders[user].find(f => f.name === folderName)) {
                ...
                try {
                    ...
                    return { statusCode: 500, body: JSON.stringify({ success: false, message: "Kunne ikke gemme mappe" }) };
                }
            ...
            if (folder && !folder.messages.includes(messageId)) {
                ...
                try {
                    ...
                    return { statusCode: 500, body: JSON.stringify({ success: false, message: "Kunne ikke gemme besked i mappe" }) };
                }
                return { statusCode: 200, body: JSON.stringify({ success: true }) };
            }
